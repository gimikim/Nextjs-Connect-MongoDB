...
export const products: Product[] = [
  {
    ...
    description:
      '클래식한 디자인과 현대적인 오버핏 실루엣이 결합된 프리미엄 트렌치 코트입니다. 방풍 및 생활 방수 기능이 뛰어난 고밀도 코튼 혼방 소재를 사용하여 변덕스러운 날씨에도 우아함을 유지할 수 있습니다. 넉넉한 핏으로 체형에 관계없이 멋스러운 스타일링이 가능합니다. (옷, 아우터)',
  },
  {
    id: 2,
  ...
  },
  {
    ...
    description:
      '핸드메이드 느낌을 살린 무광 세라믹 소재의 2인 머그 잔 세트입니다. 일상적인 커피 한 잔도 특별하게 만들어주는 감성적인 디자인으로, 열 보존율이 뛰어나 따뜻한 음료를 오랫동안 즐기기에 적합합니다. 패키징이 정성스러워 집들이 선물용으로도 인기가 많은 제품입니다. (컵, 컵세트)',
  },
  {
    id: 5,
    ...
    description:
      '수퍼 코마사 순면 100% 원단을 사용하여 피부 자극이 없고 쾌적한 착용감을 선사하는 베이직 티셔츠입니다. 넥라인에 이중 밴딩 처리를 하여 잦은 세탁에도 목 늘어남을 최소화했으며, 사계절 내내 필수 이너웨어 혹은 단독으로 활용할 수 있는 아이템입니다. (옷, 반팔)',
  },
  {
    id: 6,
  ...
  },
  {
    ...
    description:
      '트렌디한 와이드 핏과 자연스러운 빈티지 워싱이 매력적인 데님 팬츠입니다. 무릎 늘어남을 방지하는 특수 데님 원단을 사용했으며, YKK 지퍼 디테일로 내구성을 높였습니다. 롱 기장으로 신발을 살짝 덮는 스타일리시한 연출이 가능합니다. (옷, 바지)',
  },
  {
    id: 8,
    name: '천연 유기농 아로마 디퓨저',
